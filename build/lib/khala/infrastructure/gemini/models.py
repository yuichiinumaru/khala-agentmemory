...
class ModelRegistry:
    ...
    MODELS: Dict[str, GeminiModel] = {
        # Fast tier - gemini-1.5-flash
        "gemini-1.5-flash": GeminiModel(
            name="Gemini 1.5 Flash",
            tier=ModelTier.FAST,
            model_id="gemini-1.5-flash",
            cost_per_million_tokens=7.5,  # $0.0075/1M tokens
            max_tokens=8192,
        ...
        # Medium tier - gpt-4o-mini
        "gpt-4o-mini": GeminiModel(
            name="GPT-4o Mini",
            tier=ModelTier.MEDIUM,
            model_id="gpt-4o-mini",
            cost_per_million_tokens=15.0,  # $0.015/1M tokens
            max_tokens=16384,
            temperature=0.3,
            top_p=0.8,
            top_k=40
        ...
        "gemini-2.5-pro": GeminiModel(
            ...
            cost_per_million_tokens=100.0,  # $0.10/1M tokens
            max_tokens=32768,
            temperature=0.7,
            top_p=0.8,
            top_k=40
