...
from .value_objects import Query, SearchResult, SearchIntent, SignificanceScore, SearchPipeline
...
class HybridSearchService:
    ...
    def __init__(self, memory_repository: Any, entity_repository: Any):
    ...
    async def search(
        ...
        results = await self._execute_search_pipeline(query, pipeline)
